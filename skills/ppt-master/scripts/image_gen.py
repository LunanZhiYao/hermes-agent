...
Backend selection (`IMAGE_BACKEND` in `.env` or the current process environment):
  ...
  IMAGE_BACKEND=custom      -> Custom local API backend (default: http://10.0.20.130:8091)
...
BACKEND_REGISTRY = {
    ...
    "custom": {
        "module": "backend_custom",
        "tier": "core",
        "label": "Custom Local API",
        "default_model": "(server default)",
        "key_hint": "CUSTOM_IMAGE_API_URL (optional)",
        "aliases": ["local", "custom-api"],
    },
}
