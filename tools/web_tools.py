...
def _get_backend() -> str:
    ...
    if configured in ("parallel", "firecrawl", "tavily", "exa", "aliyun_opensearch"):
        return configured
...
def check_web_api_key() -> bool:
    ...
    if configured in ("exa", "parallel", "firecrawl", "tavily", "aliyun_opensearch"):
        return _is_backend_available(configured)
    return any(_is_backend_available(backend) for backend in ("exa", "parallel", "firecrawl", "tavily", "aliyun_opensearch"))
