...
OPTIONAL_ENV_VARS = {
    ...
    "ALIYUN_OPEN_SEARCH_API_KEY": {
        "description": "Aliyun OpenSearch API key for web search",
        "prompt": "Aliyun OpenSearch API key",
    ...
    "ALIYUN_OPEN_SEARCH_URL": {
        "description": "Aliyun OpenSearch web-search endpoint URL",
...
def show_config():
    ...
    keys = [
        ...
        ("ALIYUN_OPEN_SEARCH_API_KEY", "Aliyun OpenSearch"),
